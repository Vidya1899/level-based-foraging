...
class Samplespec:
    def __init__(self):
        self.spec=EnvSpec("Foraging-8x8-2p-8f-v0")
...
class ForagingEnv(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.seed()
        self.players = [Player(),Player()]#[Player() for _ in range(players)]
        ...
        #self.action_space = gym.spaces.MultiDiscrete([6])   * len(self.players) * len(self.players)
        ...
        self.unwrapped=Samplespec()
        self.spec=self.unwrapped.spec
        self.reward_range=(float("-inf"),float("inf"))#(-1000, 1000)
    ...
    def get_valid_actions(self) -> list:
        print("Valid Actions:",self._valid_actions)
    ...
    def _make_gym_obs(self, observations):
        ...
        ninfo = {}
        print("nobs:",nobs, "nreward:",nreward, "ndone:",ndone, "ninfo:",ninfo)
        agent_id= ["0","1"]
        obslist= list(nobs)
        if False in ndone: 
            donevalue= False 
            ...
            donevalue=True 
        return dict(zip(agent_id,obslist)), dict(zip(agent_id,nreward)), {"__all__":donevalue} ,dict(zip(agent_id,ninfo))
        #return ,nobs nreward[0], ndone, ninfo
    ...
    def step(self, actions):
        ...
        loading_players = set()
        #print("ACTION_2:",actions,"player_len:",len(self.players))
        # move players
